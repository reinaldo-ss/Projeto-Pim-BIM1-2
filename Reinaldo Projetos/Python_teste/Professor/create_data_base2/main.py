...
def addDados2():
    ...
    with open(caminho, "r") as f:
        dados2 = json.load(f)
        temp = dados2["names2"]
        item_dados2["name"] = input("Digite seu nome: ")
        item_dados2["profissao"] = input("Digite a sua profissao: ")
        item_dados2["materia"] = input("Digite a sua disciplina")
        temp.append(item_dados2)
    with open(caminho, "w") as f:
        json.dump(dados2, f, indent=4)
