...
def dado_repetido(valor, pergunta, alunos, chave):
    for aluno in alunos:
        if valor == aluno[chave]:
            print(f"ERRO: O {chave} digitado já está cadastrado")
            dado_repetido = True
            ...
            while dado_repetido:
                ...
                for aluno in alunos:
                    if entrada_usuario == aluno[chave]:
                        print(f"ERRO: O {chave} digitado já está cadastrado")
                    else:
                        dado_repetido = False
...
def cadastrar_novo_aluno(alunos):
    ...
    header = input("Você selecionou a opção 'cadastrar novo aluno'. Se deseja continuar, digite '1'. Se deseja voltar ao menu, digite '0': ")
    if header == "0":
    ...
    email = dado_repetido(email, "Digite o email do Aluno:", alunos, "email")
    ...
    telefone = dado_repetido(telefone, "Digite o telefone do Aluno: ", alunos, "telefone")
    cpf = validacao_geral("Digite o CPF do aluno:", validar_cpf)
    cpf = dado_repetido(cpf, "Digite o cpf do Aluno: ", alunos, "cpf")
    ...
    print(f"\n Aluno {nome} {sobrenome} cadastrado com sucesso. \n")
    return alunos
...
def listar_alunos(alunos):
    if not alunos:
        ...
        voltar_menu = input("Pressione 'Enter' para retornar ao Menu: ")
        limpaTela()
        return alunos
...
def apagar_alunos(alunos):
    ...
    raAluno = input("\nDigite o RA do aluno que deseja apagar: ")
...
# Função que modifica o cadastro de um aluno
...
def main():
    ...
    while True:
        ...
        if opcao == "1":
            ...
            limpaTela()
            print(f"\nO número '{opcao}' é inválido. Por favor, insira um valor válido.\n")
